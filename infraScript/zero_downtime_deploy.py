...
class ServiceManager:
    ...
    def _run_container(self, name: str, port: int) -> None:
        os.system(
            f"docker run -d --name={name} --restart unless-stopped -p {port}:8001 -e TZ=Asia/Seoul -v /dockerProjects/here_is_paw_msa/volumes/gen:/gen --pull always ghcr.io/here-is-paw/here_is_paw_api_gateway")
##
